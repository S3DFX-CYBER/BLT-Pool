...
def _write_mentors_data_module(yaml_content: str, mentors_path: str) -> None:
    ...
    # The backslash after the opening triple-quote is a line-continuation in the
    # generated Python source, so MENTORS_YAML starts at the first character of
    # yaml_content with no extra leading newline.
    yaml_assignment = 'MENTORS_YAML = """\\\n' + yaml_content + '"""\n'
    module_content = docstring + yaml_assignment
